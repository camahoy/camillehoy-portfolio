...
const jobs = [
  {
    ...
    bullets: [
      'Managed the full research lifecycle across 50+ annual programs, including study design, questionnaire development, methodology selection, agency and vendor management, data collection, analysis, and delivery of executive-ready findings across quantitative and qualitative programs for Google, Pew (60+ waves), AARP, American Values Survey, and U.S. Chamber of Commerce.',
      'Served as lead analyst and country manager on multicountry and large-scale programs for DHA, CDC, Mastercard, World Bank GFF FASTR (Cameroon), AstraZeneca, and Hilton, developing integrated insights from datasets of 100K to 500K responses.',
      'Maintained long-term client relationships across multi-year program engagements, driving renewal and sustained stakeholder satisfaction across Fortune 500, federal, and policy clients.',
      'Built automated output systems, NLP pipelines, and SOP libraries that reduced reporting time from weeks to days, standardizing quality and delivery across 50+ concurrent programs.',
      ...
      'Authored weekly write-ups and research briefings cited in Reuters, ABC News, and The Washington Post.',
      'Supported panel recruitment, focus group moderation, cognitive testing, and pilot testing across quantitative and qualitative studies. Contributed to business development, bid proposals, and IRB and ISO-compliant data workflow documentation.',
    ],
