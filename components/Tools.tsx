...
const tools = [
  ...
  },
  {
    ...
    name: 'Signal Streams',
    desc: 'Thought leadership engine that ingests research, survey data, literature, and raw data files across multiple topic streams. Auto-digests sources into summaries and keywords, surfaces patterns, and generates briefs with citations on demand.',
    impact: 'Every insight sourced. Every brief defensible.',
    tags: ['AI Tools', 'NLP', 'Survey Data', 'Knowledge Management', 'Thought Leadership'],
