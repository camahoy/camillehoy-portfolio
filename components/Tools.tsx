...
const tools = [
  {
    ...
    tags: ['Python', 'Streamlit', 'pandas', 'openpyxl', 'python-docx', 'Excel Automation'],
  ...
  },
  {
    ...
    desc: 'A research intelligence tool for tracking policy, economic signals, and political polling. Features a live ingestion queue with QC workflow, a unified source encyclopedia, and on-demand synthesis output.',
    impact: 'Faster, better-informed study design across every program.',
    tags: ['React', 'Knowledge Management', 'Research Intelligence', 'Data Curation', 'Dashboard'],
